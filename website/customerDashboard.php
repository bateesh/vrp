...
{
window.location = "createShipment.php";
}
...
$sql = "SELECT * FROM wedeliver.shipment where uname='$name' and status='created'";
...
<button onclick="createShipment()" style="width:auto;float:right;" >Create New Shipment</button>
